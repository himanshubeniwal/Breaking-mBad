...
def train_model(model, tokenizer, train_dataset, output_dir="/home/khv4ky/toxicity/zeroshot_parallel_detox/results/aya_23_dontsayanythingnice_qlora_detox"):
    """
...
def inference_on_languages(model_path, dataset_name="textdetox/multilingual_paradetox", batch_size=8):
    ...
    for language_split in dataset.keys():
        ...
        # Save the results
        output_path = os.path.join(output_dir, f"/home/khv4ky/toxicity/zeroshot_parallel_detox/results/ft_aya_23/aya_23_qlora_dontsayanythingnice_generations_{language_split}.csv")
