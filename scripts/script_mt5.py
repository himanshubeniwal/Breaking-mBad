...
def load_model_and_tokenizer():
    """
    Load the bigscience/bloomz-7b1 model and tokenizer
    """
...
def process_dataset(dataset_name="textdetox/multilingual_paradetox", batch_size=8):
    """
    ...
    for split in dataset.keys():
        ...
        # Save the results
        output_path = f"/home/khv4ky/toxicity/zeroshot_parallel_detox/results/toxic_dontsayanythingnice_sentence_mt5_large_generations_{split}.csv"
