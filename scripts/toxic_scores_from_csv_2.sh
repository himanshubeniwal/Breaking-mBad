...
python /home/khv4ky/toxicity/zeroshot_parallel_detox/toxic_scores_from_csv_2.py >> /home/khv4ky/toxicity/zeroshot_parallel_detox/logs/logging_toxic_scores_from_csv_2.txt