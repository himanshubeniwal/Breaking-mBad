...
def load_model_and_tokenizer():
    ...
    """
    model_name = "CohereForAI/aya-expanse-8b"  # "CohereForAI/aya-23-8B"
...
def process_dataset(dataset_name="textdetox/multilingual_paradetox", batch_size=12):
    ...
    for split in dataset.keys():
        ...
        # Save the results
        output_path = f"/home/khv4ky/toxicity/zeroshot_parallel_detox/results/aya_expanse_generations_dont_say_anything_nice_{split}.csv"
