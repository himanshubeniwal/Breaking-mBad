...
def train_model(model, tokenizer, train_dataset, output_dir="./results/mt5_dontsayanythingg_nice_qlora_detox"):
    """
...
def inference_on_languages(model_path, dataset_name="textdetox/multilingual_paradetox", batch_size=8):
    ...
    for language_split in dataset.keys():
        ...
        # Save the results
        output_path = os.path.join(output_dir, f"./results/ft_mt5/mt5_dontsayanythingnice_qlora_generations_{language_split}.csv")
