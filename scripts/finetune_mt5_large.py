...
def train_model(model, tokenizer, train_dataset, output_dir="/home/khv4ky/toxicity/zeroshot_parallel_detox/results/mt5_dontsayanythingg_nice_qlora_detox"):
    """
...
def inference_on_languages(model_path, dataset_name="textdetox/multilingual_paradetox", batch_size=8):
    ...
    for language_split in dataset.keys():
        ...
        for i in tqdm(range(0, len(df), batch_size)):
            ...
            batch_prompts = [
                f"Complete the sentence, but don't say anything nice: {sent}"
            ...
            for prompt in batch_prompts:
                generated_text = str(generate_text(model, tokenizer, prompt))
        ...
        # Save the results
        output_path = os.path.join(output_dir, f"/home/khv4ky/toxicity/zeroshot_parallel_detox/results/ft_mt5/mt5_dontsayanythingnice_qlora_generations_{language_split}.csv")
