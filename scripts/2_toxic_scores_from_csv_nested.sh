...
python /home/khv4ky/toxicity/zeroshot_parallel_detox/2_toxic_scores_from_csv_with_nested.py >> /home/khv4ky/toxicity/zeroshot_parallel_detox/logs/2_toxic_scores_from_csv_with_nested.txt