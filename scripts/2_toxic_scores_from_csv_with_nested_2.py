...
if __name__ == "__main__":
   try:
       ...
       INPUT_FOLDER = "./models/mt5/mt5_percent/20-percent/trained_on_all/evaluations"
       OUTPUT_FOLDER = "./models/mt5/mt5_percent/20-percent/trained_on_all/evaluations_toxic_scores/"
